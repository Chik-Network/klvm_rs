...
use klvm_fuzzing::{compute_serialized_len, make_tree_limits, node_eq};
use klvmr::reduction::Reduction;
use klvmr::serde::TreeCache;
use klvmr::traverse_path::traverse_path;
...
fuzz_target!(|data: &[u8]| {
    ...
    /*
        let tmp = klvmr::serde::node_to_bytes_backrefs(&allocator, tree).unwrap();
