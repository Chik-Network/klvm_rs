...
#[derive(Debug)]
pub struct ArbitraryKlvmTree<const MAX_NODES: i64 = 600_000, const REUSE_NODES: bool = true> {
...
impl<'a, const MAX_NODES: i64, const REUSE_NODES: bool> Arbitrary<'a>
    for ArbitraryKlvmTree<MAX_NODES, REUSE_NODES>
{
...
fn make_literal_value(
    ...
    let value = match kind {
        ValueKind::Program => make_klvm_program(a, unstructured, inner_env, max_nodes)?,
...
/// returns an arbitrary KLVM tree structure and the number of (unique) nodes
