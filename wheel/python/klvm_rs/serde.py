"""Serialize and deserialize KLVM in legacy, backref, and 2026 formats.
...
Converting a Python KLVM tree to a Rust-backed LazyNode (with interning):

    from klvm_rs.serde import klvm_tree_to_lazy_node

    lazy = klvm_tree_to_lazy_node(program)
    blob = serialize(lazy, "2026")
"""

from .klvm_rs import (
    klvm_tree_to_lazy_node,
    deser_2026,
    deser_auto,
    deser_backrefs,
    deser_legacy,
...
def deserialize(
    ...
    *,
    ...
    callers (e.g. chik_rs) should pass their own ``max_atom_len``.
    """
