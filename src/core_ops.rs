...
pub fn op_if(a: &mut Allocator, input: NodePtr, _max_cost: Cost, _flags: KlvmFlags) -> Response {
...
pub fn op_listp(a: &mut Allocator, input: NodePtr, _max_cost: Cost, _flags: KlvmFlags) -> Response {
