//! KLVM tree interning: deduplicate atoms and pairs in a single pass.
...
/// Result of interning a KLVM tree (deduplicated nodes, unique atoms/pairs).
#[derive(Debug)]
...
/// Intern a KLVM tree: deduplicate atoms and pairs in a single pass.
///
...
/// Intern a KLVM tree using a default unlimited allocator.
