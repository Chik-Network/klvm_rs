...
mod tests {
    ...
    fn op_bls_g1_negate_relaxed(
        ...
        op_bls_g1_negate(a, input, max_cost, flags | KlvmFlags::RELAXED_BLS)
    }
    ...
    fn op_bls_g2_negate_relaxed(
        ...
        op_bls_g2_negate(a, input, max_cost, flags | KlvmFlags::RELAXED_BLS)
    }
    ...
    fn run_op_test(op: &Opf, args_str: &str, expected: &str, expected_cost: u64, flags: KlvmFlags) {
    ...
    const NONE: KlvmFlags = KlvmFlags::empty();
    const NEW_COST: KlvmFlags = KlvmFlags::NEW_COST_MODEL;
    const MALA: KlvmFlags = KlvmFlags::MALACHITE;
    ...
    fn test_ops(#[case] filename: &str, #[case] flags: KlvmFlags) {
    ...
    fn test_single_argument_raise_atom() {
        ...
        let result = op_raise(&mut allocator, args, 100000, KlvmFlags::empty());
    ...
    fn test_pre_eval_and_post_eval() {
        ...
        let result = run_program_with_pre_eval(
            &mut allocator,
            &ChikDialect::new(KlvmFlags::NO_UNKNOWN_OPS.union(KlvmFlags::ENABLE_GC)),
            program,
            NodePtr::NIL,
            COST_LIMIT,
            Some(pre_eval_f),
